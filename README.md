# :arrows_counterclockwise: Google Translate Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Google-Translate-Power-Toy-For-Magento-2-small.png">  

Google Translate Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a quick action toy 
allowing to use Google Translate from your Magento backend/frontend.
...
* Option to translate text from one language to another
* Option to set default "from" language, incl. auto language detection
* Option to set default "to" language
* Currently supported languages: en, de, fr, ja, zh-CN, es, vn, uk, ru
...
<td>
    <table>
     <tr>
        <td><b>Google Translate Toy</b><br>Dark Mode</td>
        <td><b>Google Translate Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Google-Translate-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Google-Translate-Power-Toy-Light.jpg"></td>
    </tr>
     <tr>
     ...
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Google-Translate-Power-Toy-Popup-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Google-Translate-Power-Toy-Popup-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-google-translate
```

## Using Google Translate Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Google Translate Toy.  
...
displaying the Google Translate Toy.
A click on Google Translate Toy will open the translation chat popup.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Google_Translate_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-google-translate/blob/master/LICENSE)
